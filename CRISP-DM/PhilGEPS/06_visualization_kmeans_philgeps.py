"""
Step 06a — PhilGEPS k-means figures.

PCA-based cluster plots for each PhilGEPS lens; file naming matches the DOH visualization step
so you can diff tooling across sources.

Inputs: PhilGEPS 04_clustering *_kmeans.csv (+ minmax features)
Outputs: webp/EDA_and_visualization/PhilGEPS/06_visualization/kmeans/
"""
...
def main() -> None:
    ...
    out_dir = os.path.join(webp_root_philgeps(), "06_visualization", "kmeans")
    _ensure_dir(out_dir)
    term_log = os.path.join(logs_dir_philgeps(), "06_visualization_kmeans_philgeps_terminal.txt")
