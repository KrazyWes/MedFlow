"""
Step 07b — PhilGEPS DBSCAN metrics.

Noise-aware silhouette/CH/DB plus explicit noise ratios; pairs with the large-N DBSCAN tweaks in
step 04b so you can tell whether ε was too tight or too loose.

Inputs: PhilGEPS 04_clustering *_dbscan.csv + minmax feature files
Outputs: webp/EDA_and_visualization/PhilGEPS/07_evaluation/dbscan/
"""
...
def main() -> None:
    ...
    out_dir = os.path.join(webp_root_philgeps(), "07_evaluation", "dbscan")
    _ensure_dir(out_dir)
    term_log = os.path.join(logs_dir_philgeps(), "07_evaluation_dbscan_philgeps_terminal.txt")
